...
// Validate checks the field values on AddPostPlaceResponse with the rules
// defined in the proto definition for this message. If any rules are
// violated, the first error encountered is returned, or nil if there are no violations.
func (m *AddPostPlaceResponse) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on AddPostPlaceResponse with the rules
// defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// AddPostPlaceResponseMultiError, or nil if none found.
func (m *AddPostPlaceResponse) ValidateAll() error {
	return m.validate(true)
}

func (m *AddPostPlaceResponse) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if len(errors) > 0 {
		return AddPostPlaceResponseMultiError(errors)
	}

	return nil
}

// AddPostPlaceResponseMultiError is an error wrapping multiple validation
// errors returned by AddPostPlaceResponse.ValidateAll() if the designated
// constraints aren't met.
type AddPostPlaceResponseMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m AddPostPlaceResponseMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m AddPostPlaceResponseMultiError) AllErrors() []error { return m }

// AddPostPlaceResponseValidationError is the validation error returned by
// AddPostPlaceResponse.Validate if the designated constraints aren't met.
type AddPostPlaceResponseValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e AddPostPlaceResponseValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e AddPostPlaceResponseValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e AddPostPlaceResponseValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e AddPostPlaceResponseValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e AddPostPlaceResponseValidationError) ErrorName() string {
	return "AddPostPlaceResponseValidationError"
}

// Error satisfies the builtin error interface
func (e AddPostPlaceResponseValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sAddPostPlaceResponse.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = AddPostPlaceResponseValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = AddPostPlaceResponseValidationError{}
